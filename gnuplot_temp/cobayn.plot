...
set key top right maxrows 1 samplen 3
...
set output "cobayn_compare.pdf"
plot newhistogram "", "cobayn.dat" using ($1) title sprintf("%s","static") @fs1 @colora,\
"" using ($2) title sprintf("%s","dynamic") @fs2 @colorb,\
"" using ($3) title sprintf("%s","hybrid") @fs3 @colorg,\
